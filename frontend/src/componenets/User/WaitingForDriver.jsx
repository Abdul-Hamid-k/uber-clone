  ...
  return (
    <>
      ...
      <div
        ...
        {/* Ride details */}
        <div className="relative mt-3 pt-2 flex justify-between items-center border-t-[0.1rem] border-gray-200">
        ...
        <div className='flex items-center px-2 py-1 my-2 justify-start  gap-3 '>
